...
class db_productorder extends database_table {
    ...
    public static function inst() {
        if (self::$instance == null)
            self::$instance = new db_productorder();
        return self::$instance;
    }

    private function db_productorder() {
        parent::database_table(MYSQL_DATABASE, MYSQL_PREFIX . "productorder");
    }
