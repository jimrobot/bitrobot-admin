...
class db_customer extends database_table {
    ...
    public static function inst() {
        if (self::$instance == null)
            self::$instance = new db_customer();
        return self::$instance;
    }

    private function db_customer() {
        parent::database_table(MYSQL_DATABASE, MYSQL_PREFIX . "customer");
    }
